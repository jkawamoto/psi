...
#
"""Unit test of encryptions and decryptions defineded in dlpa package.
"""
...
class TestKeyGeneration(unittest.TestCase):
    ...
    def test_non_zero(self):
        """Test any values in a kay pair are not 0.
        """
...
class TestEncryptSum(BaseTestCase):
    ...
    def test_vector_without_randomnesss(self):
        """Run Encrypt-Sum algorithm for vectors wihtout randomness.
        """
        data = [
...
class TestEncryptSumSquared(BaseTestCase):
    """Test case for Entrypt-Sum-Squared.
    """
