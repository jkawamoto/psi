...
#
"""Public/private keys and encryption/decryption methods for the DLPA srvice.
"""
...
class PublicKey(object):  # pylint:disable=too-few-public-methods
    ...
    def encrypt(self, v):
        ...
        Args:
          v: sclar or vector to be encrypted.

        Returns:
          vector of ciphertexts; even if the input is a scalar, one dimenational
          vector is returned.
        """
...
class PrivateKey(object):
    ...
    def decrypt(self, v):
        ...
        Returns:
          vector of plain texts; even if the input is a scalar, one dimenational
          vector is returned.
        """
    ...
    def decrypt_sum(self, shares):
        """Decrypt a set of decription shares made in the encrypt-sum algorithm.
        """
